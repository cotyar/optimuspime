...
public final class MonitoringServiceGrpc {
	...
	private static volatile io.grpc.MethodDescriptor<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse> getGetStatusMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
			+ "GetStatus", requestType = calc.Cache.MonitoringUpdateRequest.class, responseType = calc.Cache.MonitoringUpdateResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
	public static io.grpc.MethodDescriptor<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse> getGetStatusMethod() {
		...
		if ((getGetStatusMethod = MonitoringServiceGrpc.getGetStatusMethod) == null) {
			synchronized (MonitoringServiceGrpc.class) {
				if ((getGetStatusMethod = MonitoringServiceGrpc.getGetStatusMethod) == null) {
					MonitoringServiceGrpc.getGetStatusMethod = getGetStatusMethod = io.grpc.MethodDescriptor.<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.UNARY)
							.setFullMethodName(generateFullMethodName("calc.MonitoringService", "GetStatus"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(calc.Cache.MonitoringUpdateRequest.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(calc.Cache.MonitoringUpdateResponse.getDefaultInstance()))
							.setSchemaDescriptor(new MonitoringServiceMethodDescriptorSupplier("GetStatus")).build();
				}
			}
		}
	...
	private static volatile io.grpc.MethodDescriptor<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse> getSubscribeMethod;

	@io.grpc.stub.annotations.RpcMethod(fullMethodName = SERVICE_NAME + '/'
			+ "Subscribe", requestType = calc.Cache.MonitoringUpdateRequest.class, responseType = calc.Cache.MonitoringUpdateResponse.class, methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
	public static io.grpc.MethodDescriptor<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse> getSubscribeMethod() {
		...
		if ((getSubscribeMethod = MonitoringServiceGrpc.getSubscribeMethod) == null) {
			synchronized (MonitoringServiceGrpc.class) {
				if ((getSubscribeMethod = MonitoringServiceGrpc.getSubscribeMethod) == null) {
					MonitoringServiceGrpc.getSubscribeMethod = getSubscribeMethod = io.grpc.MethodDescriptor.<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse>newBuilder()
							.setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
							.setFullMethodName(generateFullMethodName("calc.MonitoringService", "Subscribe"))
							.setSampledToLocalTracing(true)
							.setRequestMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(calc.Cache.MonitoringUpdateRequest.getDefaultInstance()))
							.setResponseMarshaller(io.grpc.protobuf.ProtoUtils
									.marshaller(calc.Cache.MonitoringUpdateResponse.getDefaultInstance()))
							.setSchemaDescriptor(new MonitoringServiceMethodDescriptorSupplier("Subscribe")).build();
				}
			}
		}
	...
	public static abstract class MonitoringServiceImplBase implements io.grpc.BindableService {
		...
		public final io.grpc.ServerServiceDefinition bindService() {
			return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
					.addMethod(getGetStatusMethod(), asyncUnaryCall(
							new MethodHandlers<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse>(
									this, METHODID_GET_STATUS)))
					.addMethod(getSubscribeMethod(), asyncServerStreamingCall(
							new MethodHandlers<calc.Cache.MonitoringUpdateRequest, calc.Cache.MonitoringUpdateResponse>(
	...
	public static final class MonitoringServiceStub extends io.grpc.stub.AbstractStub<MonitoringServiceStub> {
		...
		public void getStatus(calc.Cache.MonitoringUpdateRequest request,
				io.grpc.stub.StreamObserver<calc.Cache.MonitoringUpdateResponse> responseObserver) {
			asyncUnaryCall(getChannel().newCall(getGetStatusMethod(), getCallOptions()), request, responseObserver);
		}
		...
		public void subscribe(calc.Cache.MonitoringUpdateRequest request,
				io.grpc.stub.StreamObserver<calc.Cache.MonitoringUpdateResponse> responseObserver) {
			asyncServerStreamingCall(getChannel().newCall(getSubscribeMethod(), getCallOptions()), request,
					responseObserver);
		}
	}
	...
	public static final class MonitoringServiceBlockingStub
			extends io.grpc.stub.AbstractStub<MonitoringServiceBlockingStub> {
		...
		public calc.Cache.MonitoringUpdateResponse getStatus(calc.Cache.MonitoringUpdateRequest request) {
			return blockingUnaryCall(getChannel(), getGetStatusMethod(), getCallOptions(), request);
		}
		...
		public java.util.Iterator<calc.Cache.MonitoringUpdateResponse> subscribe(
			...
			return blockingServerStreamingCall(getChannel(), getSubscribeMethod(), getCallOptions(), request);
		}
	}
	...
	public static final class MonitoringServiceFutureStub
			extends io.grpc.stub.AbstractStub<MonitoringServiceFutureStub> {
		...
		public com.google.common.util.concurrent.ListenableFuture<calc.Cache.MonitoringUpdateResponse> getStatus(
				calc.Cache.MonitoringUpdateRequest request) {
			return futureUnaryCall(getChannel().newCall(getGetStatusMethod(), getCallOptions()), request);
		}
	}
	...
	private static final class MonitoringServiceMethodDescriptorSupplier extends MonitoringServiceBaseDescriptorSupplier
			...
			synchronized (MonitoringServiceGrpc.class) {
				...
				if (result == null) {
					serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
							...
							.addMethod(getGetStatusMethod()).addMethod(getSubscribeMethod()).build();
				}
			}
		}
		return result;
