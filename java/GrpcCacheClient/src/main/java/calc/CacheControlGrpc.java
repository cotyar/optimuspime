...
public final class CacheControlGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<calc.Cache.CacheInvalidateRequest,
      calc.Cache.CacheInvalidateResponse> getInvalidateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Invalidate",
      requestType = calc.Cache.CacheInvalidateRequest.class,
      responseType = calc.Cache.CacheInvalidateResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<calc.Cache.CacheInvalidateRequest,
      calc.Cache.CacheInvalidateResponse> getInvalidateMethod() {
    ...
    if ((getInvalidateMethod = CacheControlGrpc.getInvalidateMethod) == null) {
      synchronized (CacheControlGrpc.class) {
        if ((getInvalidateMethod = CacheControlGrpc.getInvalidateMethod) == null) {
          CacheControlGrpc.getInvalidateMethod = getInvalidateMethod = 
              io.grpc.MethodDescriptor.<calc.Cache.CacheInvalidateRequest, calc.Cache.CacheInvalidateResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "calc.CacheControl", "Invalidate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  calc.Cache.CacheInvalidateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  calc.Cache.CacheInvalidateResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CacheControlMethodDescriptorSupplier("Invalidate"))
                  .build();
          }
        }
     }
  ...
  private static volatile io.grpc.MethodDescriptor<calc.Cache.CacheClearRequest,
      calc.Cache.CacheClearResponse> getClearMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Clear",
      requestType = calc.Cache.CacheClearRequest.class,
      responseType = calc.Cache.CacheClearResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<calc.Cache.CacheClearRequest,
      calc.Cache.CacheClearResponse> getClearMethod() {
    ...
    if ((getClearMethod = CacheControlGrpc.getClearMethod) == null) {
      synchronized (CacheControlGrpc.class) {
        if ((getClearMethod = CacheControlGrpc.getClearMethod) == null) {
          CacheControlGrpc.getClearMethod = getClearMethod = 
              io.grpc.MethodDescriptor.<calc.Cache.CacheClearRequest, calc.Cache.CacheClearResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "calc.CacheControl", "Clear"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  calc.Cache.CacheClearRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  calc.Cache.CacheClearResponse.getDefaultInstance()))
                  .setSchemaDescriptor(new CacheControlMethodDescriptorSupplier("Clear"))
                  .build();
          }
        }
     }
   ...
   */
  public static CacheControlBlockingStub newBlockingStub(
   ...
   */
  public static CacheControlFutureStub newFutureStub(
      io.grpc.Channel channel) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                calc.Cache.CacheInvalidateRequest,
                calc.Cache.CacheInvalidateResponse>(
                  this, METHODID_INVALIDATE)))
          .addMethod(
            getClearMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                calc.Cache.CacheClearRequest,
                calc.Cache.CacheClearResponse>(
                  this, METHODID_CLEAR)))
          .build();
    }
  }
  ...
  public static final class CacheControlStub extends io.grpc.stub.AbstractStub<CacheControlStub> {
    ...
    @java.lang.Override
    protected CacheControlStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static final class CacheControlBlockingStub extends io.grpc.stub.AbstractStub<CacheControlBlockingStub> {
    ...
    @java.lang.Override
    protected CacheControlBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static final class CacheControlFutureStub extends io.grpc.stub.AbstractStub<CacheControlFutureStub> {
    ...
    @java.lang.Override
    protected CacheControlFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  private static final class CacheControlFileDescriptorSupplier
      extends CacheControlBaseDescriptorSupplier {
    CacheControlFileDescriptorSupplier() {}
  }

  private static final class CacheControlMethodDescriptorSupplier
      extends CacheControlBaseDescriptorSupplier
